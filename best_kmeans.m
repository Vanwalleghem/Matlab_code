...
for k_temp=1:dim(1)
	...
	[~,~,sumd]=kmeans(X,k_temp,'Distance','correlation','Options',options,'MaxIter',1000,'emptyaction','drop');
...
[IDX,C,SUMD]=kmeans(X,K,'Options',options,'MaxIter',1000,'Replicates',5,'Distance','correlation');